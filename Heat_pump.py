...
data = {
    'T_source': np.linspace(0, 40, 11),  # 蒸发温度从0°C到40°C，共11个点
    'T_sink': np.linspace(60, 100, 11),  # 冷凝温度从60°C到100°C，共11个点
    'eta_s': np.linspace(0.75, 0.95, 11) * 100  # 等熵效率从75%到95%，共11个点
}
# 初始化存储COP值的字典
COP = {
    'T_source': [],
